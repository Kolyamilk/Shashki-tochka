// src/components/ExpGainModal.js
...
const ExpGainModal = ({ visible, expGained, oldExp, onClose, source = 'Продажа подарка' }) => {
    ...
    >
      <Animated.View style={[styles.overlay, { opacity: fadeAnim }]}>
        ...
        >
          ...
          {leveledUp && levelUpAnim._value > 0 && (
            <Animated.View
              style={[
