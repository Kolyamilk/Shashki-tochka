// src/screens/InviteGameSetupScreen.js
...
const InviteGameSetupScreen = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <Text style={styles.title}>Пригласить в игру</Text>
        <View style={{ width: 70 }} />
      </View>

      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: Math.max(insets.bottom, 20) }]}>
        <Text style={styles.subtitle}>Выберите режим игры для {playerName}</Text>
        ...
        <TouchableOpacity
          ...
          disabled={!gameType}
        >
          <Text style={styles.startButtonText}>📨 Отправить приглашение</Text>
        </TouchableOpacity>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            • Выберите режим игры{'\n'}
            • Игрок получит приглашение мгновенно{'\n'}
            • После принятия начнётся игра
          </Text>
        </View>
      </ScrollView>
    </View>
...
export default InviteGameSetupScreen;
