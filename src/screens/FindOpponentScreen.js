...
// Интересные факты про шашки и игру
const CHECKERS_FACTS = [
  ...
  'Вы можете бросить вызов другим игрокам и сыграть дуэль!',
  'После 10 уровня вы можете обновлять все задания раз в день.',
  'С каждым новым уровнем вы получаете жетон для обновления заданий.',
  'Нашли баг? В профиле можно сообщить о проблеме!',
  'В данной игре не используется никакая реклама. Пожалуйста, оставьте отзыв :)',
];
